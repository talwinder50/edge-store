...
func TestStartCmdContents(t *testing.T) {
	...
	require.Equal(t, "Start edge-vc", startCmd.Short)
	require.Equal(t, "Start edge-vc", startCmd.Long)
...
func TestStartCmdWithMissingHostArg(t *testing.T) {
	...
	require.Equal(t,
		"Neither host-url (command line flag) nor EDGE-VC_HOST_URL (environment variable) have been set.",
		err.Error())
}
